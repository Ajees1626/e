              ...
              return (
                ...
                >
                  <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-100'} rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border group-hover:border-secondary`}>
                    ...
                    <h3 className={`text-xl md:text-2xl font-normal ${isDarkMode ? 'text-white' : 'text-primary'} mb-3 md:mb-4 group-hover:text-secondary transition-colors`}>{industry.name}</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="text-3xl md:text-4xl lg:text-5xl font-normal text-secondary mb-2">
                  {stat.number}
                </div>
