    ...
    return (
      <div className={`min-h-screen flex items-center justify-center ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="text-center">
          <h1 className={`text-4xl font-normal mb-4 ${isDarkMode ? 'text-white' : 'text-primary'}`}>Case Study Not Found</h1>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-16">
              {/* Challenge & Solution */}
              <div>
                <h2 className={`text-3xl font-normal mb-8 ${isDarkMode ? 'text-white' : 'text-primary'}`}>
                  Challenge & Solution
                </h2>
                <div className="space-y-8">
                  <div>
                    <h3 className={`text-xl font-normal mb-4 ${isDarkMode ? 'text-white' : 'text-primary'}`}>
                      The Challenge
                    </h3>
                  ...
                  {caseStudy.results.map((result, index) => (
                    <div key={index} className={`rounded-lg p-6 border ${
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-secondary font-normal">{result.improvement}</span>
                      </div>
            ...
            <div className="space-y-8">
              ...
              <div className={`rounded-2xl p-6 text-white shadow-lg ${
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-normal mb-4">Ready to Start Your Project?</h3>
                  <p className="text-white/90 mb-6">Let's discuss how we can help you achieve similar results.</p>
                  <Link 
                    to="/contact" 
                    className="bg-white text-primary font-normal py-3 px-6 rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 inline-block w-full text-center"
                  >
