    ...
    return (
      <div className={`min-h-screen flex items-center justify-center ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="text-center">
          <h1 className={`text-4xl font-normal mb-4 ${isDarkMode ? 'text-white' : 'text-primary'}`}>Service Not Found</h1>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-normal text-primary mb-2">
                {service.title}
              </h1>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-16">
              {/* Features */}
              <div>
                <h2 className={`text-3xl font-normal mb-8 ${isDarkMode ? 'text-white' : 'text-primary'}`}>What's Included</h2>
              ...
              {/* Process */}
              <div>
                <h2 className={`text-3xl font-normal mb-8 ${isDarkMode ? 'text-white' : 'text-primary'}`}>Our Process</h2>
                <div className="space-y-6">
                  {service.process.map((step, index) => (
                    <div key={index} className="flex items-start">
                      <div className="flex-shrink-0 w-8 h-8 bg-secondary text-white rounded-full flex items-center justify-center font-normal mr-4">
                        {index + 1}
                      </div>
                      <div>
                        <h3 className={`text-lg font-normal mb-2 ${isDarkMode ? 'text-white' : 'text-primary'}`}>{step.step}</h3>
              ...
              {/* Benefits */}
              <div>
                <h2 className={`text-3xl font-normal mb-8 ${isDarkMode ? 'text-white' : 'text-primary'}`}>Benefits</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-8">
              ...
              {Array.isArray(service.technicalTools) && service.technicalTools.length > 0 && (
                <div className={`rounded-2xl p-6 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-50'}`}>
                  <h3 className={`text-xl font-normal mb-4 ${isDarkMode ? 'text-white' : 'text-primary'}`}>Technical Tools</h3>
              ...
              <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-6 text-white text-center">
                <h3 className="text-xl font-normal mb-4">Ready to Get Started?</h3>
              ...
              <div className={`border rounded-2xl p-6 ${isDarkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-200'}`}>
                <h3 className={`text-xl font-normal mb-4 ${isDarkMode ? 'text-white' : 'text-primary'}`}>Why Choose Us?</h3>
