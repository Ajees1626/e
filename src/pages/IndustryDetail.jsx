    ...
    return (
      <div className={`min-h-screen flex items-center justify-center ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="text-center">
          <h1 className={`text-4xl font-normal mb-4 ${isDarkMode ? 'text-white' : 'text-primary'}`}>Industry Not Found</h1>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-6">
                <div className={`flex items-center ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  ...
                  <span className="font-normal text-xl">{formatMetric(industry.projects)}</span>
                </div>
                <div className={`flex items-center ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  <FaUsers className="mr-2 text-secondary" />
                  <span className="font-normal text-xl">{formatMetric(industry.clients)}</span>
                </div>
                <div className={`flex items-center ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  <FaChartLine className="mr-2 text-secondary" />
                  <span className="font-normal text-xl">{formatMetric(industry.growth)}</span>
                </div>
              </div>
            </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-16">
              {/* Services */}
              <div>
                <h2 className={`text-3xl font-normal ${isDarkMode ? 'text-white' : 'text-primary'} mb-8`}>Our Services</h2>
              ...
              {/* Features */}
              <div>
                <h2 className={`text-3xl font-normal ${isDarkMode ? 'text-white' : 'text-primary'} mb-8`}>Key Features</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Benefits */}
              <div>
                <h2 className={`text-3xl font-normal ${isDarkMode ? 'text-white' : 'text-primary'} mb-8`}>Benefits</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Case Studies */}
              <div>
                <h2 className={`text-3xl font-normal ${isDarkMode ? 'text-white' : 'text-primary'} mb-8`}>Success Stories</h2>
                <div className="space-y-6">
                  {(industry.caseStudies || []).map((study, index) => (
                    <div key={index} className={`${isDarkMode ? 'bg-gray-700' : 'bg-gray-50'} rounded-2xl p-6`}>
                      <h3 className={`text-xl font-normal ${isDarkMode ? 'text-white' : 'text-primary'} mb-2`}>{study.title}</h3>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-secondary font-normal">{study.results}</span>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-6 text-white text-center">
                <h3 className="text-xl font-normal mb-4">Ready to Transform Your {industry.name} Business?</h3>
                <p className="text-white/90 mb-6">Let's discuss how our solutions can help your organization succeed.</p>
                <Link 
                  to="/contact" 
                  className="bg-white text-primary font-normal py-3 px-6 rounded-lg hover:bg-gray-100 transition-colors inline-block"
                >
              ...
              <div className={`${isDarkMode ? 'bg-gray-700 border-gray-600' : 'bg-white border-gray-200'} border rounded-2xl p-6`}>
                <h3 className={`text-xl font-normal ${isDarkMode ? 'text-white' : 'text-primary'} mb-4`}>Industry Impact</h3>
